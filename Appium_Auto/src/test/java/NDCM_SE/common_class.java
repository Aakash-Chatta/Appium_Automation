...
public class common_class {
	...
	File app = new File(appDir, "NDCMSE_4.2.0.646_beta.apk");
	...
	dc.setCapability("appPackage", "se.nordea.sme.beta");
	dc.setCapability("appActivity", "nb.features.launcher.SplashActivity");
